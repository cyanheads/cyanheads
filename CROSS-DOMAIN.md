...
More than 60 servers span federal and state government, scientific and legal literature, genomics and chemistry, macroeconomics, geospatial data, cybersecurity, and public health. Connect them and an agent can chase a question across domains in one conversation. No ETL, no warehouse, no integration code.

An agent *can* hit any of these APIs directly: read the docs, register a key, hand-roll the requests, paginate, reshape the JSON. Do that six times in a single investigation and the context window is gone before the question gets answered. Each MCP server collapses a source to one structured tool call, and the fleet is self-describing: a search for "campaign finance" surfaces OpenFEC, "known vulnerabilities" surfaces OSV. The agent finds the right server by concept, calls it, and gets structured data back. The chains below thread four to seven sources, joined on the identifiers that pass from one server to the next.
...
[**Congress**](https://github.com/cyanheads/congressgov-mcp-server) → [**OpenFEC**](https://github.com/cyanheads/openfec-mcp-server) → [**USAspending**](https://github.com/cyanheads/usaspending-mcp-server) → [**SEC EDGAR**](https://github.com/cyanheads/secedgar-mcp-server) → [**OpenStates**](https://github.com/cyanheads/openstates-mcp-server)
...
[**PubChem**](https://github.com/cyanheads/pubchem-mcp-server) → [**OpenFDA**](https://github.com/cyanheads/openfda-mcp-server) → [**ClinicalTrials.gov**](https://github.com/cyanheads/clinicaltrialsgov-mcp-server) → [**PubMed**](https://github.com/cyanheads/pubmed-mcp-server) + [**bioRxiv**](https://github.com/cyanheads/biorxiv-mcp-server) → [**SEC EDGAR**](https://github.com/cyanheads/secedgar-mcp-server) → [**WHO**](https://github.com/cyanheads/who-gho-mcp-server)
...
[**OSV**](https://github.com/cyanheads/osv-advisory-mcp-server) → [**NIST NVD**](https://github.com/cyanheads/nist-nvd-mcp-server) → [**SEC EDGAR**](https://github.com/cyanheads/secedgar-mcp-server) → [**Congress**](https://github.com/cyanheads/congressgov-mcp-server) → [**arXiv**](https://github.com/cyanheads/arxiv-mcp-server)
...
> **Real data — Log4Shell (CVE-2021-44228):** one vulnerable version of log4j-core returns 7 OSV advisories: the original RCE plus the incomplete-fix follow-ups (CVE-2021-45046, -45105, -44832). NVD scores it CVSS 10.0, and its CISA KEV entry gave federal agencies a hard remediation deadline; the affected-product list includes Siemens industrial controllers, Cisco gear, and Apple Xcode. SEC EDGAR full-text returns 582 filings naming "Log4j" (186 10-Ks, 237 10-Qs, 18 8-Ks), with companies still citing it years later. 25 arXiv papers. No vulnerability database tracks that corporate-disclosure blast radius; the chain reconstructs it.
...
[**OneBusAway**](https://github.com/cyanheads/onebusaway-mcp-server) → [**Census**](https://github.com/cyanheads/census-mcp-server) → [**OpenStreetMap**](https://github.com/cyanheads/openstreetmap-mcp-server) → [**FCC**](https://github.com/cyanheads/fcc-broadband-mcp-server) → [**BLS**](https://github.com/cyanheads/bls-labor-mcp-server) → [**WSDOT**](https://github.com/cyanheads/wsdot-mcp-server) → [**OpenStates**](https://github.com/cyanheads/openstates-mcp-server)
...
[**Library of Congress**](https://github.com/cyanheads/libofcongress-mcp-server) → [**Smithsonian**](https://github.com/cyanheads/smithsonian-mcp-server) → [**Wikipedia**](https://github.com/cyanheads/wikipedia-mcp-server) → [**Wikidata**](https://github.com/cyanheads/wikidata-mcp-server) → [**OpenAlex**](https://github.com/cyanheads/openalex-mcp-server) + [**Crossref**](https://github.com/cyanheads/crossref-mcp-server) → [**OpenLibrary**](https://github.com/cyanheads/openlibrary-mcp-server)
...
[**WHO**](https://github.com/cyanheads/who-gho-mcp-server) → [**CDC**](https://github.com/cyanheads/cdc-health-mcp-server) → [**GDELT**](https://github.com/cyanheads/gdelt-mcp-server) → [**bioRxiv**](https://github.com/cyanheads/biorxiv-mcp-server) → [**PubMed**](https://github.com/cyanheads/pubmed-mcp-server) → [**ClinicalTrials.gov**](https://github.com/cyanheads/clinicaltrialsgov-mcp-server) → [**GBIF**](https://github.com/cyanheads/gbif-biodiversity-mcp-server) → [**EIA**](https://github.com/cyanheads/eia-energy-mcp-server) + [**BLS**](https://github.com/cyanheads/bls-labor-mcp-server)
...
[**Census**](https://github.com/cyanheads/census-mcp-server) → [**BLS**](https://github.com/cyanheads/bls-labor-mcp-server) → [**NWS**](https://github.com/cyanheads/nws-weather-mcp-server) + [**Open-Meteo**](https://github.com/cyanheads/open-meteo-mcp-server) → [**Earthquake**](https://github.com/cyanheads/earthquake-mcp-server) → [**FCC**](https://github.com/cyanheads/fcc-broadband-mcp-server) → [**OpenStreetMap**](https://github.com/cyanheads/openstreetmap-mcp-server) → [**OneBusAway**](https://github.com/cyanheads/onebusaway-mcp-server) → [**Socrata**](https://github.com/cyanheads/socrata-mcp-server)
...
[**OpenAlex**](https://github.com/cyanheads/openalex-mcp-server) → [**ORCID**](https://github.com/cyanheads/orcid-mcp-server) → [**Crossref**](https://github.com/cyanheads/crossref-mcp-server) → [**PubMed**](https://github.com/cyanheads/pubmed-mcp-server) + [**arXiv**](https://github.com/cyanheads/arxiv-mcp-server) + [**bioRxiv**](https://github.com/cyanheads/biorxiv-mcp-server) → [**Wikidata**](https://github.com/cyanheads/wikidata-mcp-server)

Map a research field quantitatively. OpenAlex for the citation graph and publication trends over time (group results by year, institution, or topic). ORCID to disambiguate the authors and build dossiers; Crossref for the funder records behind the work. Pull the domain literature from PubMed, arXiv, and bioRxiv in parallel, then resolve entities to stable identifiers in Wikidata. The output is a field map: who dominates, where the citation clusters are, what's surging in preprints, and which questions no one is funding.
...
[**Census**](https://github.com/cyanheads/census-mcp-server) → [**CDC**](https://github.com/cyanheads/cdc-health-mcp-server) → [**Open-Meteo**](https://github.com/cyanheads/open-meteo-mcp-server) → [**USGS Water**](https://github.com/cyanheads/usgs-water-mcp-server) → [**FEMA**](https://github.com/cyanheads/fema-mcp-server) → [**OpenStreetMap**](https://github.com/cyanheads/openstreetmap-mcp-server) → [**Socrata**](https://github.com/cyanheads/socrata-mcp-server) → [**OpenStates**](https://github.com/cyanheads/openstates-mcp-server)
...
Each server exposes structured, queryable data through the [Model Context Protocol](https://modelcontextprotocol.io). An agent with several connected can chain across them with no integration code. Two things make that chaining actually hold together:
...
The numbers in this document came from real queries across these servers: 582 SEC filings naming Log4j, Microsoft as both a Cantwell donor and a $459.8M federal contractor, 12,089 adverse-event reports for a single drug.
