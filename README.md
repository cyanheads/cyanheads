...
- [model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)
...
- [mailchimp-mcp-server](https://github.com/cyanheads/mailchimp-mcp-server)

### AI services

- [mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)
- [perplexity-mcp-server](https://github.com/cyanheads/perplexity-mcp-server)

### Hardware & notifications

- [ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)
- [pixoo-mcp-server](https://github.com/cyanheads/pixoo-mcp-server)
